pub mod physics {
	...
	pub mod projectile {
		pub const MASS: f64 = 0.21225; // The mass of the projectile, kg.
...
pub mod simulation {
	pub const DISTANCE_MIN: f64 = 0.1; // The minimum distance that will be simulated, m.
	pub const DISTANCE_MAX: f64 = 7.5; // The maximum distance that will be simulated, m.
